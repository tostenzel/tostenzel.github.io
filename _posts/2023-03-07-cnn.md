...
A Convolutional Neural Networks (CNN) [@lecun_gradient-based_1998] is
...
Figure [2](#fig:cross-correlation){reference-type="ref"
reference="fig:cross-correlation"} illustrates Equation
[\[eq:cross-correlation\]](#eq:cross-correlation){reference-type="ref"
...
{% include figure.html path="assets/img/dl-series/cross-correlation.png" style="width:50%" class="center" %}
...
{% include figure.html path="assets/img/dl-series/gradient-cross-correlation.png" style="width:50%" class="center" %}
...
graphs. An early implementation of this idea is Microsoft's ResNet
<d-cite key="he_deep_2016"></d-cite>. This architecture uses skip connections that only skip
